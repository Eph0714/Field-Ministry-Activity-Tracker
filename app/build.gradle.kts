...
android {
    namespace = "com.fieldministry.app"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BUILD_VERSION", "\"1.0.6\"")
    }
...
androidComponents {
    onVariants { variant ->
        variant.outputs.forEach { output ->
            (output as? com.android.build.api.variant.impl.VariantOutputImpl)?.outputFileName?.set("fieldministry.apk")
        }
    }
}
